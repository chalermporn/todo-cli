...
const vueaddmenu = require("./commands/vueaddmenu");
...
program.command("create vue").description("Create file vuejs").action(vue);

program.command("vue-add").description("Add file vuejs").action(vueadd);

program.command("menu").description("Add menu file vuejs").action(vueaddmenu);

program.command("vue-find").description("find file vuejs").action(vuefind);
